# Zeusyxa Smart Contracts

Smart contracts deploying Zeusyxa on EVM chains (Ethereum, Base, Arbitrum, Polygon) — enabling real token launch with DEX liquidity, before the standalone L1 is ready.

## 📦 Contracts

| File | Mô tả |
|------|-------|
| `ZeusyxaToken.sol` | ERC-20 with burn, permit, governance, tax-on-AI-use |
...
| `ZeusyxaStaking.sol` | Stake để earn reward + boost |
...
**Phase A**: Deploy `ZeusyxaToken` lên Base mainnet → create Uniswap V3 pool → có giá thật
